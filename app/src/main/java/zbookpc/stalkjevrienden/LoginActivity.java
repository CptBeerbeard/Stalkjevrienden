...
import static zbookpc.stalkjevrienden.R.id.password;
import static zbookpc.stalkjevrienden.R.id.phone;
import static zbookpc.stalkjevrienden.RegisterActivity.PERMISSION_EXTERNAL_STORAGE_LOCATION;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(phone)) {
            mPhoneView.setError("Please enter your phone number.");
    ...
    private class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                String url = "http://192.168.178.29:9018/login";
                URL obj = new URL(url);
